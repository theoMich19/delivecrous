...
export const meals: Meal[] = [
  {
    ...
    description:
      "Salade composée avec du poulet grillé, des croûtons à l'ail et du parmesan, le tout assaisonné d'une sauce César crémeuse.",
    restaurantId: "1",
    ingredients: [
      "Salade romaine",
  ...
  },
  {
    ...
    categoryIds: ["cat1"],
    description:
      "Lasagnes traditionnelles à la bolognaise, préparées avec une sauce tomate mijotée, de la viande de bœuf hachée et une béchamel onctueuse, le tout gratinés au four.",
    restaurantId: "1",
    ingredients: [
      "Pâtes à lasagne",
  ...
  },
  {
    ...
    categoryIds: ["cat1", "cat5"],
    description:
      "Burger végétarien avec steak de légumes maison, fromage, tomates fraîches et salade croquante, servi dans un pain aux céréales.",
    restaurantId: "4",
    ingredients: [
      "Pain burger aux céréales",
      "Steak végétal (légumineuses, légumes)",
      "Cheddar",
      "Tomate",
      "Salade",
      "Sauce maison",
  ...
  },
  {
    ...
    categoryIds: ["cat2"],
    description:
      "Le classique jambon-beurre dans une baguette croustillante, préparé avec du jambon blanc de qualité et du beurre demi-sel.",
    restaurantId: "2",
    ingredients: ["Baguette traditionnelle", "Jambon blanc", "Beurre demi-sel"],
  ...
  {
    id: "meal5",
    name: "Buddha Bowl Végétalien",
    imageUrl: "/api/placeholder/400/300",
    price: "4,20€",
    categoryIds: ["cat1", "cat5"],
    description:
      "Bowl équilibré à base de quinoa, légumes de saison, avocat, pois chiches grillés et sauce tahini maison. Un repas complet, sain et savoureux.",
    restaurantId: "3",
    ingredients: [
      "Quinoa",
  ...
  },
  {
    ...
    categoryIds: ["cat1"],
    description:
      "Émincé de poulet au curry doux, servi avec du riz basmati et des légumes. Un plat savoureux inspiré de la cuisine indienne.",
    restaurantId: "8",
    ingredients: [
      "Filet de poulet",
      "Riz basmati",
  ...
  },
  {
    ...
    categoryIds: ["cat2"],
    description:
      "Wrap frais garni de thon, crudités croquantes et sauce légère. Une option équilibrée et pratique à emporter.",
    restaurantId: "5",
    ingredients: [
      "Tortilla de blé",
      "Thon au naturel",
  ...
  },
  {
    ...
    categoryIds: ["cat3"],
    description:
      "Tarte aux pommes traditionnelle avec une pâte feuilletée croustillante et des pommes caramélisées légèrement parfumées à la cannelle.",
    restaurantId: "6",
    ...
    isVegan: false,
    isGlutenFree: false,
    preparationTime: "0 min (prêt à servir)",
    popularity: 4,
  },
  {
    id: "meal9",
    ...
    imageUrl: "/api/placeholder/400/300",
    price: "2,50€",
    categoryIds: ["cat4", "cat3"],
    description:
      "Smoothie rafraîchissant aux fruits rouges, préparé avec des fruits frais et un yaourt nature. Riche en vitamines et antioxydants.",
    restaurantId: "7",
    ingredients: [
      "Fraises",
      "Framboises",
  ...
  },
  {
    ...
    description:
      "Bowl hawaïen à base de riz, saumon frais mariné, avocat, concombre et graines de sésame. Un repas complet, frais et équilibré.",
    restaurantId: "10",
    ingredients: [
      "Riz japonais",
      "Saumon frais",
  ...
  },
  {
    ...
    description:
      "Panini chaud garni de mozzarella, cheddar et chèvre, avec un soupçon de pesto. Croustillant à l'extérieur et fondant à l'intérieur.",
    restaurantId: "9",
    ingredients: [
      "Pain panini",
      "Mozzarella",
  ...
  },
  {
    ...
    description:
      "Salade composée de fruits frais de saison, parfaite pour un dessert léger et vitaminé.",
    restaurantId: "2",
    ingredients: [
      "Pomme",
      "Banane",
  ...
  },
  {
    ...
    categoryIds: ["cat1", "cat6"],
    description:
      "Nuggets de poulet croustillants servis avec des frites maison et sauce au choix. Un classique revisité.",
    restaurantId: "4",
    ingredients: [
  ...
  },
  {
    ...
    price: "0,70€",
    categoryIds: ["cat4"],
    description: "Bouteille d'eau minérale naturelle de 50cl.",
    restaurantId: "3",
    ingredients: ["Eau minérale naturelle"],
    allergens: [],
    nutritionalInfo: {
      Calories: "0 kcal",
      Minéraux: "Selon source",
    },
    isVegetarian: true,
    isVegan: true,
    isGlutenFree: true,
  ...
  },
  {
    ...
    categoryIds: ["cat4"],
    description:
      "Expresso fraîchement préparé avec un café 100% arabica. Idéal pour une pause énergisante.",
    restaurantId: "5",
  ...
  },
  {
    ...
    categoryIds: ["cat1"],
    description:
      "Quiche traditionnelle au jambon et lardons, avec une pâte brisée maison et une garniture crémeuse aux œufs.",
    restaurantId: "6",
    ingredients: [
      "Pâte brisée",
      "Lardons",
    ...
    isVegan: false,
    isGlutenFree: false,
    preparationTime: "5 min (réchauffage)",
    popularity: 4,
  },
  {
    id: "meal17",
    ...
    categoryIds: ["cat1", "cat5"],
    description:
      "Salade traditionnelle composée de tomates, œufs durs, thon, olives et haricots verts. Fraîche et méditerranéenne.",
    restaurantId: "10",
    ingredients: [
      "Salade verte",
      "Tomates",
  ...
  },
  {
    ...
    categoryIds: ["cat3", "cat5"],
    description:
      "Yaourt nature crémeux de 125g, produit localement avec du lait frais.",
    restaurantId: "1",
  ...
  },
  {
    ...
    categoryIds: ["cat2"],
    description:
      "Sandwich chaud garni de jambon et fromage, grillé au four pour un extérieur croustillant et un intérieur fondant.",
    restaurantId: "7",
    ingredients: ["Pain de mie", "Jambon blanc", "Emmental", "Béchamel légère"],
    allergens: ["Gluten", "Lactose"],
    nutritionalInfo: {
      Calories: "350 kcal",
      Protéines: "20g",
  ...
  },
  {
    ...
    imageUrl: "/api/placeholder/400/300",
    price: "2,50€",
    categoryIds: ["cat3", "cat6"],
    description:
      "Dessert italien traditionnel à base de mascarpone, café et biscuits, légèrement saupoudré de cacao.",
    restaurantId: "8",
    ingredients: [
      "Mascarpone",
      "Œufs",
